...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('admin.tour.update', $data->id) }}" class="nav-align-top" method="POST" enctype="multipart/form-data">
            @method('put')
            @csrf
                ...
                <div class="tab-pane fade" id="navs-top-gallery" role="tabpanel">
                    ...
                    <div class="gallery-box-wrapper">
                        ...
                        <div class="gallery-box">
                            <img src="{{ $gallery->getImageURL() }}" onerror="this.src='{{ asset('assets/admin/img/skeleton/not-found-image.png') }}'" class="preview-gallery" alt="">
                            ...
                            <input type="hidden" name="temp_galleries[]" value="{{ $gallery->id }}" class="temp-gallery-input">
                            <input type="file" name="galleries[{{ $gallery->id }}]" class="upload-gallery-input" accept="image/*">
                        </div>
                        @endforeach
                    </div>
                </div>
