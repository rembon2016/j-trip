...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb ms-3 mb-4">
        ...
        <li class="breadcrumb-item">
            <a href="{{ route('admin.users.staff.index') }}">Staff</a>
        </li>
...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('admin.users.staff.store') }}" class="row" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="tel" class="form-control @error('phone') is-invalid @enderror" name="phone" id="phone" value="{{ old('phone') }}" placeholder="Masukkan Nomor HP">
                @error('phone')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="col-12 mb-3">
                ...
                <textarea name="address" id="address" class="form-control @error('address') is-invalid @enderror" rows="5" placeholder="Masukkan Alamat">{{ old('address') }}</textarea>
                @error('address')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            <div class="col-12">
                <button type="submit" class="btn btn-primary w-100">
                    <span class="tf-icons bx bx-plus me-1"></span> Tambahkan Staff
                </button>
            </div>
        </form>
    </div>
